...
**For Cracking: You need only the "passphrases" file.** This is stored in Git Large File Storage (glfs), so download via <a href="https://github.com/initstring/passphrase-wordlist/raw/master/passphrases.txt" download>this link</a> or use git clone if you have the glfs extensions installed.
